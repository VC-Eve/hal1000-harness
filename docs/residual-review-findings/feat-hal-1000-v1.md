...
- Claude Code log-format drift remains the largest external dependency risk; tolerant parsing and unreadable-state degradation bound the blast radius but not narration quality.
